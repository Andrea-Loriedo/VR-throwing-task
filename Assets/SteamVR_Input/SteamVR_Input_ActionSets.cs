...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_dartsplaying p_dartsplaying;
        ...
        public static SteamVR_Input_ActionSet_dartsplaying dartsplaying
        {
            get
            {
                return SteamVR_Actions.p_dartsplaying.GetCopy<SteamVR_Input_ActionSet_dartsplaying>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_dartsplaying = ((SteamVR_Input_ActionSet_dartsplaying)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_dartsplaying>("/actions/dartsplaying")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.dartsplaying};
        }
    }
}
